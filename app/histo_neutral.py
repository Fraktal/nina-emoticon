...
f_sad = open("sad_histo.pickle", "wb") 
...
words_gen_sad = (word.strip(punctuation).lower() for line in open('sad_histo.pickle') 
...
plt.hist(x, bins=200, range = (0,1000), color = 'blue', histtype = 'stepfilled') 
